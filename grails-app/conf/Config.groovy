...
tomcat.deploy.username="bwobbones"
tomcat.deploy.password="bwobbon3s"
tomcat.deploy.url="http://192.168.1.8:8080/manager"
...
environments {
    production {
        grails.serverURL = "http://localhost/DTDataServer"
    }
    development {
